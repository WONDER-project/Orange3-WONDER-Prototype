...
if not is_recovery:
    ...
    from orangecontrib.xrdanalyzer.recovery.controller.fit.fit_parameter import FitParameter
    from orangecontrib.xrdanalyzer.recovery.controller.fit.fit_global_parameters import FitGlobalParameters
    from orangecontrib.xrdanalyzer.recovery.controller.fit.microstructure.constrast_factor import calculate_A_B_coefficients
    from orangecontrib.xrdanalyzer.recovery.controller.fit.microstructure.strain import KrivoglazWilkensModel
